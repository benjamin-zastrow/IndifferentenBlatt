<!DOCTYPE html>
<head>
    <title>Das IndifferentenBlatt - National</title>
    <meta charset="UTF-8">
    <meta lang="de">
...
<body>
    <nav>
        ...
        <ul>
            <li><a href="index.php"><img src="img/politics.png" width="40px"></a></li>
            <li><a id="currentSite" href="national.php">National</a></li>
