<!DOCTYPE html>
<head>
    <title>Das IndifferentenBlatt - International</title>
    <meta charset="UTF-8">
    <meta lang="de">
...
<body>
    <nav>
        ...
        <ul>
            <li><a href="index.php"><img src="img/globe.png" width="40px"></a></li>
            <li><a href="national.php">National</a></li>
            <li><a id="currentSite" href="international.php">International</a></li>
